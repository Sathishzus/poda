...
from prime import (BOT_USERNAME, MESSAGE_DUMP_CHAT, SUDOERS, USERBOT_ID,
                 USERBOT_NAME, USERBOT_USERNAME, aiohttpsession, app,
                 app2, arq)
from prime.core.types import InlineQueryResultCachedDocument
from prime.modules.info import get_chat_info, get_user_info
from prime.modules.music import download_youtube_audio
from prime.utils.functions import test_speedtest
...
async def alive_function(answers):
    ...
    msg = f"""
**[Powered By FoxXBotOfficials✨](https://t.me/foxxbotofficials):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
async def music_inline_func(answers, query):
    chat_id = -1001349208513
    group_invite = "https://t.me/jokersupportz"
    try:
        messages = [
            m
